angular.module('Arvici').controller('PageController', ["$scope", "$state", "$interval", "appService", "AppService", "$rootScope",function($scope, $state, $interval, appService, AppService, $rootScope) {
